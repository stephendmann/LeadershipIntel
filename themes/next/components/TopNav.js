  ...
  return (
        <div id='top-nav' className='block lg:hidden'>
            ...
            <div id='sticky-nav' className={`${siteConfig('NEXT_NAV_TYPE', null, CONFIG) !== 'normal' ? 'fixed' : 'relative'} lg:relative w-full top-0 z-20 transform duration-500`}>
                <div className='w-full flex justify-between items-center p-4 bg-[#1b263b] dark:bg-gray-900 text-white border-b border-[rgba(0,85,119,0.2)]'>
                    {/* 左侧LOGO 标题 */}
                    ...
                    {/* 右侧功能 */}
                    <div className='mr-1 flex justify-end items-center text-sm space-x-4 font-sans dark:text-gray-200'>
