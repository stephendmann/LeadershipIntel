const CONFIG = {
  ...
  // Category-scoped masthead experiment; must match props.category exactly. Empty string = off everywhere
  NEXT_AI_HERO_CATEGORY: process.env.NEXT_PUBLIC_AI_HERO_CATEGORY || '',
